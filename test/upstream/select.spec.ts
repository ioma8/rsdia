...
// Ported from ASCIIFlow (client/draw/select.spec.ts), MIT © Lewis Hemens.
...
import { layerToText, textToLayer } from "../../src/core/text";
...
describe("DrawSelect", () => {
  ...
  // Upstream also has "shift-clicking adds a second box to the selection and moves both":
  // lazydraw dropped shift-click add-to-selection, so that case no longer applies here.
});
